...
def build_index(data_loader, model,**kwargs):
    output_emb_size = kwargs['output_emb_size']
    hnsw_max_elements = kwargs['hnsw_max_elements']
    hnsw_ef = kwargs['hnsw_ef']
    hnsw_m =kwargs['hnsw_m']
